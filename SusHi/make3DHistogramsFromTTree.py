...
for type_boson in type_bosons:
    inputTxt = '/nfs/dust/cms/user/asmusspa/private/CMSSW_9_2_15/src/SusHi/output_100PerJob/txtFiles/' + type_boson + '.txt'
    print inputTxt
...
# Ouptut file
    output_name = '/nfs/dust/cms/user/asmusspa/private/CMSSW_9_2_15/src/SusHi/output_100PerJob/rootFiles/Histograms3D_' + type_boson + '.root'
